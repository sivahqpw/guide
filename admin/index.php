...
<div class="container">
  ...
  <a class="navbar-brand" href="../admin/"><i class="fas fa-search mr-1"></i> JobFinder</a>
  ...
  <div class="collapse navbar-collapse" id="navbarColor01">
	...
	<li class="nav-item">
	<a class="nav-link" href="../admin/index.php"><span class="fas fa-user" aria-hidden="true"></span> Admin</a>
	</li>
	<li class="nav-item">
	<a class="nav-link" href="../"><span class="fas fa-eye" aria-hidden="true"></span> View Site</a>
	</li>
